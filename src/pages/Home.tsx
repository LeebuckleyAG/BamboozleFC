...
export default function Home(props: HomeProps) {
  ...
  return (
    <>
      <Header page="101" title="BAMBOOZLE FC" statusText="BBC-TEXT STYLE FOOTBALL SERVICE · NO INTERNET REQUIRED" showMascot />
      <div className="flex-1 min-h-0 overflow-y-auto px-3 py-4 sm:px-5">
        ...
        <div className="mt-6 bg-[var(--tx-red)] text-black font-mono text-[11px] font-bold text-center py-1.5 tracking-widest uppercase">
